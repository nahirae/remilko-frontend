...
export default function RecipeCard({
  ...
  const handleBookmark = () => {
    const existingBookmarks = JSON.parse(localStorage.getItem("bookmarkedRecipes") || "[]");
    const updatedBookmarks = isBookmarked
      ? existingBookmarks.filter((b: any) => b.id !== id)
      : [...existingBookmarks, { id, title, image, user, profile }];
