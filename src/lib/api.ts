...
// --- Helper Methods ---
// GET
export const getNoAuth = (url: string, config = {}) => apiRequest("get", url, null, false, config);
export const getAuth = (url: string, config = {}) => apiRequest("get", url, null, true, config);

// POST
export const postNoAuth = (url: string, data: any, config = {}) => apiRequest("post", url, data, false, config);
export const postAuth = (url: string, data: any, config = {}) => apiRequest("post", url, data, true, config);

// PUT
export const putNoAuth = (url: string, data: any, config = {}) => apiRequest("put", url, data, false, config);
export const putAuth = (url: string, data: any, config = {}) => apiRequest("put", url, data, true, config);

// DELETE
export const deleteNoAuth = (url: string, config = {}) => apiRequest("delete", url, null, false, config);
